...
public class Shooter extends SubsystemBase {
    ...
    private static CANSparkMax Shooter = new CANSparkMax(ShooterConstants.Shooter1,MotorType.kBrushless);
    private static DigitalOutput ledRing = new DigitalOutput (ShooterConstants.LedRelay);
