...
public class Vision extends SubsystemBase {
    ...
    public static NetworkTable table = inst.getTable("vision"); 
    public static NetworkTableEntry goalEntry = table.getEntry("goal");
    public static NetworkTableEntry blueCargoEntry = table.getEntry("bluecargo");
    public static NetworkTableEntry redCargoEntry = table.getEntry("redcargo");
