...
CANSparkMax sparkMaxLF = new CANSparkMax(3,MotorType.kBrushless);
 
 

CANSparkMax sparkMaxLB = new CANSparkMax(0,MotorType.kBrushless);   
 
 

CANSparkMax sparkMaxRF = new CANSparkMax(1,MotorType.kBrushless);
 
 

CANSparkMax sparkMaxRB = new CANSparkMax(2,MotorType.kBrushless);
