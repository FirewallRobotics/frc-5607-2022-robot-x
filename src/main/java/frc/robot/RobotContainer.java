...
public final JoystickButton joystickButton6 = new JoystickButton(Joystick1, 6);
  ...
  private RobotContainer() {
    ...
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=SUBSYSTEM_DEFAULT_COMMAND
        m_driveTrain.setDefaultCommand(
          ...
          new RunCommand(
              () ->
                  m_driveTrain.Drive(
                      Joystick1.getX(), -Joystick1.getY(), Joystick1.getThrottle()),
              m_driveTrain));
    ...
    m_chooser.setDefaultOption("Autonomous Command", new SequentialCommandGroup(
       new ShootingCargoCommand(m_shooter).alongWith(new FlushIndexerCommand(m_indexer)).withTimeout(3),
  ...
  private void configureButtonBindings() {
    ...
    // Create some buttons
    joystickButton1.whenPressed(new ShootingCargoCommand(m_shooter).alongWith(new FlushIndexerCommand(m_indexer)).withTimeout(3));
