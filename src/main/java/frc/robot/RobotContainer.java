...
public final JoystickButton joystickButton6 = new JoystickButton(Joystick1, 6);
  ...
  private RobotContainer() {
    ...
    m_chooser.setDefaultOption("Autonomous Command", new AutoDriveCommand(m_driveTrain));
  ...
  private void configureButtonBindings() {
    ...
    joystickButton3.whileHeld(new ClimberExtendCommand(m_climbing));
    joystickButton3.whenReleased(new ClimberStopCommand(m_climbing));
    joystickButton4.whileHeld(new ClimberRetractCommand(m_climbing));
