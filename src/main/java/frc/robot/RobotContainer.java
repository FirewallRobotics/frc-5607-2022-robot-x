...
public final JoystickButton joystickButton6 = new JoystickButton(Joystick1, 6);
  ...
  private void configureButtonBindings() {
    ...
    // Create some buttons
    joystickButton1.whenPressed(new ShootingCargoCommand(m_shooter));
    joystickButton2.whileHeld(new IntakeCargoCommand(m_intake));
    joystickButton2.whenReleased(new IntakeStopCommand(m_intake));
    joystickButton3.whenPressed(new ClimberExtendCommand(m_climbing));
    joystickButton4.whenPressed(new ClimberRetractCommand(m_climbing));
    joystickButton5.whenPressed(new FlushIndexerCommand(m_intake));
    joystickButton6.whenPressed(new ClimberStopCommand(m_climbing));
